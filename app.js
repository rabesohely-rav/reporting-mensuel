...
function buildPieOptions(legendPosition = 'right', showLegend = true) {
  return {
    responsive: true,
    maintainAspectRatio: false,
    layout: { padding: 6 },
    plugins: {
      legend: { display: showLegend, position: legendPosition, labels: { boxWidth: 16, font: { size: 10 } } },
      datalabels: {
        color: '#555',
...
function renderHtmlLegend(containerId, rows, colors) {
